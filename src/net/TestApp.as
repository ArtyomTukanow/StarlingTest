package net {
  ...
  public class TestApp extends Sprite {
    ...
    private function init(e: Event = null): void {
      ...
      VK.addEventListener('onRequestSuccess', function(): void{
        tf.appendText("onRequestSuccess\n");
      });
      VK.addEventListener('onRequestCancel', function(): void{
        tf.appendText("onRequestCancel\n");
      });
      VK.addEventListener('onRequestFail', function(): void{
        tf.appendText("onRequestFail\n");
      });
      ...
      var btn5: VKButton = new VKButton('Send Request');
      ...
      btn4.addEventListener(MouseEvent.CLICK, function(e: Event):void{
        VK.callMethod("showMerchantPaymentBox", {
          ...
          item_currency_1: 643,
          item_quantity_1: 1,
          item_photo_url_1: 'https://vk.com/images/gifts/96/149.png',
          item_digital_1: 1
        });
      });
      btn5.addEventListener(MouseEvent.CLICK, function(e: Event):void{
        VK.callMethod("showRequestBox", 66748, "test");
      });
    }
  }
}
